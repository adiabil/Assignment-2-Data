...
router.get('/sessions', (req, res) => {
  res.status(200).json(manager.getAllSessions());
});

router.get('/sessions/:id', (req, res) => {
  const sessionId = req.params.id; // Extract id from path parameters
...
router.put('/sessions/:id', (req, res) => {
  ...
  const body = req.body;
  const updated = manager.updateSession(sessionId, body);
